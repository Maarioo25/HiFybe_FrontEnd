  ...
  return (
    <div className="flex flex-col h-screen bg-harmony-primary overflow-hidden">
      ...
      <div className="flex-1 overflow-hidden container mx-auto px-6 pt-8">
        <div className="max-h-[calc(100vh-24px)] bg-harmony-secondary/30 backdrop-blur-sm rounded-2xl border border-harmony-text-secondary/10 flex flex-col overflow-y-auto">
